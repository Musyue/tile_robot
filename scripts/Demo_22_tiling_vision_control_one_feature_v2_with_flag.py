...
def main():
    ...
    uvcentral_place=[335,172]#320,201#180323,174#325,163#355,diyige canshuda,you yi
    uvcentral = [369,123]#sucking central109-125OK,370,201#368,95#120#362,123#133da xiang xia,
    First_joint_angular=[]
    calibinfo=[
        0.109982645426,
        0.114476746567,
    ...
    Desire_joint_angular_place_state = [-175.78,-82.87,-112.83,18.08,86.98,43.05]#43.5
        ...
        try:
            ...
            if len(q_now) != 0:
                ...
                if open_move_to_desire_flag==1:
                    ...
                    MoveUrString=F0.Move_ur(Desire_joint_angular_place_state, ace, vel, urt)
